...
class SuccessResponse {
  ...
  send({message, data, edges, pageInfo, count}: { message: string; data?: Partial<any>; edges?: Partial<any>; count?: number; pageInfo?: PageInfoInterface; }) {
    return {message, data, edges, count, pageInfo};
  }
}
